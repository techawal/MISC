...
<?
 if($state=='form'){
?>
 <form style="float:left;width:50%" method="post" action=""> 
...
?>
  ...
  <input type="submit" name="submit" value="Unsubscribe" style="background-color:#bbbbbb;border:2px solid red;margin-left:30%;width:40%;color:green;font-weight:bold;font-size:23pt;"><br>
</form>
<!--</div>-->
<?
 echo '<a href="http://minhinc.42web.io/training/'.$tech.'"><img style="float:left;width:45%" src="http://minhinc.42web.io/image/'.$tech.'traininglogo.gif"></img></a>';
 }else{
 echo '<a href="http://minhinc.42web.io/image/'.$tech.'"><img style="margin-left:32%;width:35%" src="http://minhinc.42web.io/image/'.$tech.'traininglogo.gif"></img></a>';
?>
 <pre style="margin:20px 25%;line-height:48px;text-align:center;background-color:#cccccc;font-family:mytwcenmt;font-size:28pt;color:#FF0000;font-weight:bold;width:50%"><? echo $state ?></pre>
<?
 }
}
function draw($util) {
