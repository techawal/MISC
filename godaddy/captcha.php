...
$font = '../misc/ufonts.com_tw-cen-mt.ttf';

$image = imagecreatetruecolor(80, 30); //Change the numbers to adjust the size of the image
$black = imagecolorallocate($image, 0, 0, 0);
$color = imagecolorallocate($image, 0, 100, 90);
$white = imagecolorallocate($image, 0, 26, 26);

imagefilledrectangle($image,0,0,399,99,$white);
imagettftext ($image, 20, 0, 10, 25, $color, $font, $math );//Change the numbers to adjust the font-size
