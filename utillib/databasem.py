...
class databasec:
 ...
 def create(self):
  ...
  crsr.execute("CREATE TABLE IF NOT EXISTS qt (id INT NOT NULL DEFAULT 0 PRIMARY KEY, name VARCHAR(80), lab VARCHAR(580), content TEXT, UNIQUE(id))")
  crsr.execute("CREATE TABLE IF NOT EXISTS qml (id INT NOT NULL DEFAULT 0 PRIMARY KEY, name VARCHAR(80), lab VARCHAR(580), content TEXT, UNIQUE(id))")
  crsr.execute("CREATE TABLE IF NOT EXISTS c (id INT NOT NULL DEFAULT 0 PRIMARY KEY, name VARCHAR(80), lab VARCHAR(580), content TEXT, UNIQUE(id))")
  crsr.execute("CREATE TABLE IF NOT EXISTS cpp (id INT NOT NULL DEFAULT 0 PRIMARY KEY, name VARCHAR(80), lab VARCHAR(580), content TEXT, UNIQUE(id))")
  crsr.execute("CREATE TABLE IF NOT EXISTS gl (id INT NOT NULL DEFAULT 0 PRIMARY KEY, name VARCHAR(80), lab VARCHAR(580), content TEXT, UNIQUE(id))")
  crsr.execute("CREATE TABLE IF NOT EXISTS py (id INT NOT NULL DEFAULT 0 PRIMARY KEY, name VARCHAR(80), lab VARCHAR(580), content TEXT, UNIQUE(id))")
  crsr.execute("CREATE TABLE IF NOT EXISTS li (id INT NOT NULL DEFAULT 0 PRIMARY KEY, name VARCHAR(80), lab VARCHAR(580), content TEXT, UNIQUE(id))")
